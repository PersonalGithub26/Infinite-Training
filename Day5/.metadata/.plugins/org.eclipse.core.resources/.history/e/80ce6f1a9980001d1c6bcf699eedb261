...
public class Employee {
	...
	public Employee( String firstName, String lastName, double salary, int leaveAvail, 
			double hra, double da,
			double ta, double tax, double gross, double takeHome) {
...
//				+ ", leaveAvail=" + leaveAvail + ", hra=" + hra + ", da=" + da + ", ta=" + ta + ", tax=" + tax
//				+ ", gross=" + gross + ", takeHome=" + takeHome + "]";
//	}
