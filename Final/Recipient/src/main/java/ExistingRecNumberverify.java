...
import javax.persistence.NoResultException;import org.hibernate.Criteria;
...
@RequestScoped
@FacesValidator("com.java.project.ExistingProviderNumberverify")
public class ExistingRecNumberverify implements Validator, Serializable{ 
	@Override
 ...
 if(count == 0)
 {
 FacesMessage msg = new FacesMessage("Invalid MailId or Account not Registered with this MailId", uniqueColumn);
